...
const StoreUpdate = (props) => {
  ...
  return (
    ...
    <div className='ststststs'>
      ...
      <form className={ styles.writeForm } style={{maxWidth:800, textAlign:'center'}} id={store_seq} value={store_seq} >
          ...
          <tbody>
            ...
            <tr>
              <td colSpan='2' align='center'>
                <button  style={{all:'unset',color:'blue',cursor:'pointer'}} onClick={ onWriteSubmit }>상품 수정</button>
               &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
